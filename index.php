...
<div class="searchbox w-75 p-3" style="background-color: #abe9cd;background-image: linear-gradient(315deg, #abe9cd 0%, #3eadcf 74%); height:260px; margin:70px auto;">
                        ...
                        <div class="col-12 col-md-10 col-lg-8">
                            <form class="card card-sm">
                                <div class="card-body row no-gutters align-items-center">
                                    ...
                                    <!--end of col-->
                                    <div class="col">
                                      <input class="form-control form-control-lg form-control-borderless" name="s11" type="text" placeholder="Search keywords" required>
                                    </div>
                                    <!--end of col-->
                                    <div class="col-auto">
